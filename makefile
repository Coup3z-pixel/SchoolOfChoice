...
sch_ch: main.c cee.o student.o subset.o partalloc.o schchprob.o parser.o
	$(CC) -o sch_ch main.c cee.o student.o subset.o partalloc.o schchprob.o parser.o -lm
