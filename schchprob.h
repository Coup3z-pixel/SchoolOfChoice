...
int safe_schools_are_safe(struct input_sch_ch_prob* myscp);
...
struct process_scp left_sub_process_scp(struct process_scp* myscp,
					struct subset* J_subset, struct subset* P_subset);

struct process_scp right_sub_process_scp(struct process_scp* myscp,
					 struct subset* J_subset, struct subset* P_subset);
